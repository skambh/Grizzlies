...
def load_lineitem(data_folder: str) -> pd.DataFrame:
    ...
    df = read_tbl(os.path.join(data_folder, "lineitem.tbl"), columns)
...
def load_part(data_folder: str) -> pd.DataFrame:
    ...
    return read_tbl(os.path.join(data_folder, "part.tbl"), columns)
...
def load_orders(data_folder: str) -> pd.DataFrame:
    ...
    df = read_tbl(os.path.join(data_folder, "orders.tbl"), columns)
...
def load_customer(data_folder: str) -> pd.DataFrame:
    ...
    return read_tbl(os.path.join(data_folder, "customer.tbl"), columns)


@functools.lru_cache
def load_nation(data_folder: str) -> pd.DataFrame:
    columns = ["N_NATIONKEY", "N_NAME", "N_REGIONKEY", "N_COMMENT"]
    return read_tbl(os.path.join(data_folder, "nation.tbl"), columns)


@functools.lru_cache
def load_region(data_folder: str) -> pd.DataFrame:
    columns = ["R_REGIONKEY", "R_NAME", "R_COMMENT"]
    return read_tbl(os.path.join(data_folder, "region.tbl"), columns)
...
def load_supplier(data_folder: str) -> pd.DataFrame:
    ...
    return read_tbl(os.path.join(data_folder, "supplier.tbl"), columns)
...
def load_partsupp(data_folder: str) -> pd.DataFrame:
    ...
    return read_tbl(os.path.join(data_folder, "partsupp.tbl"), columns)
